...
<!-- <button class="btnnn"><i class="bi bi-pen"></i>
<a href="insert.php" class="btnn btn-primary" role="button"></button></a>
<button class="btnn"><i class="fa fa-trash"></i>
<a href="delete.php" class="btnn btn-danger" role="button"></a>
</button> -->
<!-- POUR METTRE LES BOUTONS AVEC ICÔNES -->
